...
public class UDPProvider {
    ...
    private static class Provider extends Thread {
        ...
        @Override
        public void run() {
            log.info("org.zhq.UDPProvider provider start");
            try {
                ...
                while (!done) {
                    ...
                    log.info("org.zhq.UDPProvider receive from ip:{} port:{} length:{} data:{},isValid:{}", clientIp.getHostAddress(), clientPort, clientLength, data, isValid);
                    ...
                    if (cmd == 1 && responsePort > 0) {
                        ...
                        log.info("org.zhq.UDPProvider send to ip:{} port:{} length:{} data:{}",clientIp.getHostAddress(),responsePort,len,buf);
                    }else{
                        log.info("org.zhq.UDPProvider nonsupport cmd. cmd:{}",cmd);
                    }
                }
            ...
            log.info("org.zhq.UDPProvider provider stop");
        }
