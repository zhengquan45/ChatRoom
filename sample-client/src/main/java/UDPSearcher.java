...
public class UDPSearcher {
    ...
    private static void sendBroadcast() throws IOException {
        ...
        log.info("UDPSearcher sendBroadcast ip:{} port:{} length:{} data:{}","255.255.255.255",UDPConstants.PORT_SERVER,len,byteBuffer.array());
    ...
    private static Listener listen(CountDownLatch receiveLatch) throws InterruptedException {
        log.info("UDPSearcher listen start");
        ...
        public void run() {
            ...
            try {
                ...
                while (!done) {
                    ...
                    log.info("UDPSearcher receive from ip:{} port:{} data:{} dataLen:{} isValid:{}", ip.getHostAddress(), port, data, dataLen, isValid);
                    if (!isValid) {
                        continue;
                    }
                    ...
                    if (cmd != 2 || serverPort <= 0) {
                        log.info("UDPSearcher nonsupport cmd. cmd:{} serverPort:{}", cmd, serverPort);
                        continue;
                    }
